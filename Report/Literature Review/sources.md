...
- [Procedural generation of dungeons](https://graphics.tudelft.nl/Publications-new/2014/LLB14/Procedural.pdf)

## Books
- [Procedural Content Generation in Games](https://link.springer.com/content/pdf/10.1007/978-3-319-42716-4.pdf)
...
- [3D Game Model and Texture Generation Using Interactive Genetic Algorithm](https://cilab.gist.ac.kr/hp/wp-content/uploads/2018/12/4.-3D-Game-Model-and-Texture.pdf)
...
## Game Mechanics, Level Generation, etc
### Papers
- [Automatic Generation of Game Levels Based on Controllable Wave Function Collapse Algorithm](https://link.springer.com/chapter/10.1007/978-3-030-65736-9_3)

## Architecture
### Papers
- [Procedural Generation of Video Game Cities for Specific Video Game Genres Using WaveFunctionCollapse (WFC)](https://www.researchgate.net/publication/336732478_Procedural_Generation_of_Video_Game_Cities_for_Specific_Video_Game_Genres_Using_WaveFunctionCollapse_WFC)


# Machine Learning, Neural Networks, Genetic Algorithms
## Game Mechanics, Level Generation, etc
### Papers
- [Game Level Clustering and Generation Using Gaussian Mixture VAEs](https://ojs.aaai.org/index.php/AIIDE/article/view/7422)
- [Conditional Level Generation and Game Blending](https://arxiv.org/abs/2010.07735)
- [Level Generation Through Large Language Models](https://arxiv.org/pdf/2302.05817)
- [Sampling Hyrule: Sampling ProbabilisticMachine Learning for Level Generation](https://ojs.aaai.org/index.php/AIIDE/article/view/12817/12665)
- [Polymorph: dynamic difficulty adjustment through level generation](https://dl.acm.org/doi/abs/10.1145/1814256.1814267)
- [Patterns as Objectives for Level Generation](https://www.researchgate.net/publication/245024235_Patterns_as_Objectives_for_Level_Generation)
- [Procedural level generation with answer set programming for general Video Game playing](https://www.researchgate.net/publication/308871748_Procedural_level_generation_with_answer_set_programming_for_general_Video_Game_playing)
- [DOOM Level Generation using Generative Adversarial Networks](https://arxiv.org/pdf/1804.09154)
- [Procedural generation of dungeons’ maps and locked-door missions through an evolutionary algorithm validated with players](https://www.sciencedirect.com/science/article/pii/S0957417421004504)
- [A Hierarchical MdMC Approach to 2D Video Game Map Generation](https://ojs.aaai.org/index.php/AIIDE/article/view/12794)
- [Co-Generation of Game Levels and Game-Playing Agents](https://ojs.aaai.org/index.php/AIIDE/article/view/7431)

## Dialogue, Quests, Missions
### Papers
- [Affective dialogue generation for video games](https://essay.utwente.nl/89325/1/Kalbiyev_MA_EEMCS.pdf)
- [Personalized Quest and Dialogue Generation in Role-Playing Games: A Knowledge Graph- and Language Model-based Approach]()


# Multiple, Unspecified, or Novel Generation Methods

## Game Models, Items, etc
### Papers
- [Volcano: An Interactive Sword Generator](https://re.public.polimi.it/bitstream/11311/984873/1/07377226.pdf)

## Game Mechanics, Level Generation, etc
### Papers
- [Automatic Game Design via Mechanic Generation](https://ojs.aaai.org/index.php/AAAI/article/view/8788)
...
- [Toward Supporting Stories with Procedurally Generated Game Worlds](https://faculty.cc.gatech.edu/~riedl/pubs/cig11.pdf)
- [A framework for interactive, autonomous and semantic dialogue generation in games](https://opus.bibliothek.uni-wuerzburg.de/files/24602/2021-GTS-Proceedings_03-paper.pdf)
- [Characters Who Speak Their Minds: Dialogue Generation in Talk of the Town](https://ojs.aaai.org/index.php/AIIDE/article/view/12877/12725)
- [A Lightweight Videogame Dialogue Manager](https://dl.digra.org/index.php/dl/article/view/798/798)

# Other
## Papers
- [The VGLC: The Video Game Level Corpus](https://arxiv.org/pdf/1606.07487)